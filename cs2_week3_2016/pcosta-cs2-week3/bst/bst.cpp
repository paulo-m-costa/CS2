...
/**
 * The segmentation fault happened because the root node of the binary tree
 * was never declared. The memory leak occurred because no nodes were ever
 * freed. I fixed these issues by initializing a root node and freeing all
 * nodes in the destructor.
 */
