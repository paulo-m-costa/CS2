...
/**
 * @brief: Tells if the path drawn through three points is a left turn using
 * cross products.
 *
 * @param point1: Starting point.
 * @param point2: Midpoint.
 * @param point3: End point.
 *
 * @return: 1 if it is a left turn, 0 otherwise.
 */
...
/**
 * @brief: Adds the points that make up the convex hull in order using the gift
 * wrap algorithm.
 *
 * @param points: The points to be gift wrapped.
 * @param app: The convex hull app the points are added to.
 */
